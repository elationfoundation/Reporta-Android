...
import com.iwmf.fragments.CheckinEndTimeFragment;

/**
 * <p> Custom Time Picker for user to select time for checkin. </p>
 */
@SuppressWarnings("ALL")
public class CheckinEndTimeActivity extends BaseAppCompatActivity {

    private static final String TAG = CheckinEndTimeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            CheckinEndTimeFragment fragment = new CheckinEndTimeFragment();
