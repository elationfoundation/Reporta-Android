...
import com.iwmf.fragments.ProfileEditFragment;

/**
 * <p> User can edit profile here also it has an option to change user password. </p>
 */
...
public class ProfileEditActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            addFragment(new ProfileEditFragment(), false);
        }
    }
