package com.iwmf.views.stickylistheaders;
...
import com.iwmf.R;
import com.iwmf.views.stickylistheaders.WrapperViewList.LifeCycleListener;

/**
 * Even though this is a FrameLayout subclass we still consider it a ListView. This is because of 2 reasons: 1. It acts like as ListView. 2. It used
 * to be a ListView subclass and refactoring the name would cause compatibility errors.
 *
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    /**
     * Use the method with extreme caution!! Changing any values on the underlying ListView might break everything.
     *
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         * @param header The currently sticky header being offset. This header is not guaranteed to have it's measurements set. It is however guaranteed
         *               that this view has been measured, therefor you should user getMeasured* methods instead of get* methods for determining the
         *               view's size.
    ...
    public interface OnStickyHeaderChangedListener {
         ...
         * @param itemPosition The position of the item within the adapter's data set of the item whose header is now sticky.
