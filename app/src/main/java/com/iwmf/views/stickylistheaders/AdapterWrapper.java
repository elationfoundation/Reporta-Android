...
/**
 * A {@link ListAdapter} which wraps a {@link StickyListHeadersAdapter} and automatically handles wrapping the result of
 * {@link StickyListHeadersAdapter#getView(int, android.view.View, android.view.ViewGroup)} and
 * {@link StickyListHeadersAdapter#getHeaderView(int, android.view.View, android.view.ViewGroup)} appropriately.
 *
