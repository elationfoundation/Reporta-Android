...
/**
 * <p> Model class for facebook utilities. </p>
 */
...
public class Utility extends Application {
     ...
     */
    public static String getAppToken(String APP_ID, String APP_Secret) {

        String access_token = null;
        String url = "https://graph.facebook.com/oauth/access_token?grant_type=client_credentials&client_id=" + APP_ID + "&client_secret=" + APP_Secret;
        try {
            URL aURL = new URL(url);
            URLConnection conn = aURL.openConnection();
            conn.connect();
            ...
            while (st.hasMoreTokens()) {
                ...
                // System.out.println(key + "\t" + access_token);
            }
