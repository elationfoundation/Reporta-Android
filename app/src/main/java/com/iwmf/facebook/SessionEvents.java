...
/**
 * <p> Model class to store information of user session events.
 * NOT USED. </p>
 */
...
public class SessionEvents {
    ...
    public interface AuthListener {
        ...
        /**
         * Called when a auth flow completes successfully and a valid OAuth Token was received. Executed by the thread that initiated the
    ...
    public interface LogoutListener {
        ...
        /**
         * Called when logout begins, before session is invalidated. Last chance to make an API call. Executed by the thread that initiated the
         * logout.
         */
        void onLogoutBegin();
