...
/**
 * <p> Adapter to add contact to circle.
 * <p/>
 * Initialized from AddContactToCircleFragment </p>
 */
public class AddContactsToCircleAdapter extends BaseAdapter implements StickyListHeadersAdapter, SectionIndexer {

    //private static final String TAG = AddContactsToCircleAdapter.class.getSimpleName();
    ...
    public AddContactsToCircleAdapter(ArrayList<Contacts> mContacts, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mArrayList.get(position) != null) {
            ...
            try {
                ...
                if (mArrayList.get(position).getSos_enabled().equals("1")) {
