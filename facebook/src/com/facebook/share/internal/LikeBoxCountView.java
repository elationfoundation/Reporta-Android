...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        LayoutParams likeCountLabelLayoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        likeCountLabel.setLayoutParams(likeCountLabelLayoutParams);
        likeCountLabel.setGravity(Gravity.CENTER);
        likeCountLabel.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.com_facebook_likeboxcountview_text_size));
    ...
    private void setAdditionalTextPadding(int left, int top, int right, int bottom) {
        likeCountLabel.setPadding(textPadding + left, textPadding + top, textPadding + right, textPadding + bottom);
    }
