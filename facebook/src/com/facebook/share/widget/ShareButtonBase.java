...
public abstract class ShareButtonBase extends FacebookButtonBase {
    ...
    protected ShareButtonBase(final Context context, final AttributeSet attrs, final int defStyleAttr, final String analyticsButtonCreatedEventName) {
     ...
     * {@link FacebookSdk#isFacebookRequestCode(int)}. This method should also be
     ...
     *
     * @param callbackManager The {@link CallbackManager} instance that will be
