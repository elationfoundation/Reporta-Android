...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, GameRequestDialog.Result> {
    ...
    public static final class Result {
        ...
        private Result(Bundle results) {
            ...
            while (results.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, this.to.size()))) {
                this.to.add(results.getString(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, this.to.size())));
            }
        }
    ...
    private class WebHandler extends ModeHandler {
        ...
        public AppCall createAppCall(final GameRequestContent content) {
            ...
            DialogPresenter.setupAppCallForWebDialog(appCall, GAME_REQUEST_DIALOG, WebDialogParameters.create(content));
