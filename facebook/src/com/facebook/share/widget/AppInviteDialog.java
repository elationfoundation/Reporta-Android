...
public class AppInviteDialog extends FacebookDialogBase<AppInviteContent, AppInviteDialog.Result> {
    ...
    private static boolean canShowNativeDialog() {
        return (Build.VERSION.SDK_INT >= ShareConstants.MIN_API_VERSION_FOR_WEB_FALLBACK_DIALOGS) && DialogPresenter.canPresentNativeDialogWithFeature(getFeature());
    }

    private static boolean canShowWebFallback() {
        return (Build.VERSION.SDK_INT >= ShareConstants.MIN_API_VERSION_FOR_WEB_FALLBACK_DIALOGS) && DialogPresenter.canPresentWebFallbackDialogWithFeature(getFeature());
    }
        ...
        public AppCall createAppCall(final AppInviteContent content) {
            ...
            DialogPresenter.setupAppCallForNativeDialog(appCall, new DialogPresenter.ParameterProvider() {
                ...
                public Bundle getLegacyParameters() {
                    ...
                    Log.e(TAG, "Attempting to present the AppInviteDialog with " + "an outdated Facebook app on the device");
                    return new Bundle();
                }
            }, getFeature());
    ...
    private class WebFallbackHandler extends ModeHandler {
        ...
        public AppCall createAppCall(final AppInviteContent content) {
            ...
            DialogPresenter.setupAppCallForWebFallbackDialog(appCall, createParameters(content), getFeature());
