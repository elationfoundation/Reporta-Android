...
public final class Validate {
    ...
    private static final String NO_INTERNET_PERMISSION_REASON = "No internet permissions granted for the app, please add " +
            "<uses-permission android:name=\"android.permission.INTERNET\" /> " +
            "to your AndroidManifest.xml.";

    private static final String FACEBOOK_ACTIVITY_NOT_FOUND_REASON = "FacebookActivity is not declared in the AndroidManifest.xml, please add " +
    ...
    private static final String CONTENT_PROVIDER_NOT_FOUND_REASON = "A ContentProvider for this app was not set up in the AndroidManifest.xml, please " +
    ...
    public static void hasFacebookActivity(Context context, boolean shouldThrow) {
        ...
        if (pm != null) {
            ComponentName componentName = new ComponentName(context, FacebookActivity.class);
            try {
