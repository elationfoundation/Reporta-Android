...
public class TestUserManager {
    ...
    private AccessToken getAccessTokenForUser(List<String> permissions, Mode mode, String uniqueUserTag) {
        ...
        return new AccessToken(testAccount.optString("access_token"), testApplicationId, testAccount.optString("id"), permissions, null, AccessTokenSource.TEST_USER, null, null);
    }
