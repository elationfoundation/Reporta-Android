...
public class LoginFragment extends Fragment {
    ...
    private void onLoginClientCompleted(LoginClient.Result outcome) {
        ...
        int resultCode = (outcome.code == LoginClient.Result.Code.CANCEL) ? Activity.RESULT_CANCELED : Activity.RESULT_OK;
    ...
    public void onPause() {
        ...
        getActivity().findViewById(R.id.com_facebook_login_activity_progress_bar).setVisibility(View.GONE);
    }
