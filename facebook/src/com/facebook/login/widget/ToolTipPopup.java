...
public class ToolTipPopup {
    ...
    public void show() {
        if (mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            mPopupContent.measure(View.MeasureSpec.makeMeasureSpec(decorWidth, View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(decorHeight, View.MeasureSpec.AT_MOST));
