...
class KatanaProxyLoginMethodHandler extends LoginMethodHandler {
    ...
    boolean tryAuthorize(LoginClient.Request request) {
        ...
        Intent intent = NativeProtocol.createProxyAuthIntent(loginClient.getActivity(), request.getApplicationId(), request.getPermissions(), e2e, request.isRerequest(), request.hasPublishPermission(), request.getDefaultAudience());
