...
class AccessTokenCache {
    ...
    public AccessTokenCache() {
        this(FacebookSdk.getApplicationContext().getSharedPreferences(AccessTokenManager.SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE), new SharedPreferencesTokenCachingStrategyFactory());
    }
